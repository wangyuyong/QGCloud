...
public class WriteFragment extends Fragment implements AuthorityContract.AuthorityView {


    @BindView(R.id.expand_is_write)
    ExpandableListView writeExpandList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.fragment_is_write, container, false);
    ...
    private void initView() {
        writeExpandList.setGroupIndicator(null);
        writeExpandList.setAdapter(adapter);
        registerForContextMenu(writeExpandList);
    }
